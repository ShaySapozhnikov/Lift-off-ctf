...
export default function CountDown() {
  ...
  return (
    <div className="bg-zinc-900 min-h-[300px] sm:min-h-[350px] md:h-[400px] border-2 border-gray-500 border-dashed rounded-md p-2 sm:p-4 overflow-auto">
      ...
      <h1 className="italic font-bold text-white text-center text-base sm:text-lg md:text-xl font-mono mt-2 sm:mt-3 md:mt-4 animate-pulse px-2">
        Countdown: {timeLeft}
      </h1>
    </div>
  );
